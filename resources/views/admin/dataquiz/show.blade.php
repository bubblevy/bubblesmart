        ...
        <div class="justify-content-end">
          <form action="/admin/data-quiz/q&a/{{ $code }}/search">
            <div class="input-group">
              <input type="search" class="form-control" name="q" id="search" style="border: 1px solid #d9dee3;" placeholder="Cari Pertanyaan..." autocomplete="off" />
            </div>
          </form>
        </div>
      </div>
...
<div id="errorModaladdQuestion" data-error-question="@error('question') {{ $message }} @enderror" data-error-option1="@error('option.1') {{ $message }} @enderror" data-error-option2="@error('option.2') {{ $message }} @enderror" data-error-option3="@error('option.3') {{ $message }} @enderror" data-error-option4="@error('option.4') {{ $message }} @enderror" data-error-score="@error('score') {{ $message }} @enderror" data-error-correct="@error('correct') {{ $message }} @enderror"></div>
<!-- Modal add question-->
<div class="modal fade" id="formModalAdminAddQuestions" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="" method="post" class="modalAdminAddQuestions">
      @csrf
